...
// BMH: Added _inplace suffix to error-prone overloads
...
namespace modp {
     ...
     */
    inline std::string& url_encode_inplace(std::string& s)
    {
     ...
     * \return a reference to the input string
     */
    inline std::string& url_min_encode_inplace(std::string& s)
    {
     ...
     */
    inline std::string& url_decode_inplace(std::string& s)
    {
    ...
    inline std::string& url_decode_raw_inplace(std::string& s)
    {
